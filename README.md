...
📁 Advanced Info: Directory Structure<details><summary><b>🖱️ Click to expand the folder architecture</b></summary>Below is the visual map of the CopraSorter project structure:Plaintext📦 CopraSorter
